...
# Source: Tirto (https://instagram.com/tirtoid)

library(jsonlite)
library(tidyverse)
library(lubridate)

tirto_raw <- fromJSON("data-raw/tirtoid.json")
...
save(tirto_posts, file = "data/tirto_posts.rda", compress = "bzip2", compression_level = 9)
...
save(tirto_comments, file = "data/tirto_comments.rda", compress = "bzip2", compression_level = 9)
