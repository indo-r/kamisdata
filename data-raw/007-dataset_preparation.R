...
# Source: Marvel Cinematic Universe Wiki (https://marvelcinematicuniverse.fandom.com)
...
save(mcu_characters, file = "data/mcu_characters.rda", compress = "bzip2", compression_level = 9)
