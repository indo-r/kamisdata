# Contributor: Raden Muhammad Hadi
# Source: Kejaksaan Republik Indonesia (https://www.kejaksaan.go.id/infoperkara.php?idu=0&idsu=11&sec=pid)
...
save(data_container4, file = "data/perkara_pidana_per_dokumen.rda", compress = "bzip2", compression_level = 9)
